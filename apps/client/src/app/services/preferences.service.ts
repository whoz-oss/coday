...
export class PreferencesService {
  ...
  constructor() {
    ...
    const storedEnterToSend = this.getPreference<boolean>('useEnterToSend', true) ?? true
    ...
    const storedHideWarningMessages = this.getPreference<boolean>('hideWarningMessages', false) ?? false
