/**
 * CallPipe and ApplyPipe — pure-function invocation pipes for Angular templates.
 * Inspired by / credited to https://ngxtension.dev/
 */
...
export class CallPipe implements PipeTransform {
  transform<T = any, R = any>(value: T, args?: (param: T) => R): R {
    if (typeof args !== 'function') throw new TypeError('You must pass a PURE function to | call')
...
export class ApplyPipe implements PipeTransform {
  transform<TFunction extends (...args: any[]) => any>(
    ...
    if (typeof fn !== 'function') throw new TypeError('You must use | apply on a PURE function')
