 ...
 * @param threadService - ThreadService for accessing persisted threads; used as fallback when the thread
 *   is not active in memory (e.g. delegation sub-threads that have already completed)
 */
