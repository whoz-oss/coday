...
Always use Kotlin 2's raw string delimiter `$"""..."""` for `@Query` annotation
arguments. Inside a `$"""` raw string, `$paramName` is a literal dollar sign
followed by the parameter name — exactly what the Cypher engine expects.
...
**Do not use** the following alternatives — they either fail to compile or are
hard to read and fragile under tooling:

| Form | Problem |
|---|---|
| `"""...\$param..."""` | `\# Neo4j Persistence
...
deserialisation throws `InvalidTypeIdException`.
 ...
 is not a valid Kotlin escape; compiler rejects it as a non-constant annotation argument |
| `"""...${'
...
}param..."""` | Works but is hard to read and gets mangled by file-write tools |
| `"""...$param..."""` | Kotlin interpolates `$param` as a variable; produces "unresolved reference" errors |
