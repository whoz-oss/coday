...
/**
 * Unit tests for the [ScheduledPromptSearchRequest] cross-field `@AssertTrue` constraints
 * ([ScheduledPromptSearchRequest.isNamespaceIdentifierValid] and
 * [ScheduledPromptSearchRequest.isUserIdentifierValid]).
 *
 ...
 * [PlanningDtoUnitSpec] for the same rationale.
 */
class ScheduledPromptSearchRequestUnitSpec : StringSpec({
