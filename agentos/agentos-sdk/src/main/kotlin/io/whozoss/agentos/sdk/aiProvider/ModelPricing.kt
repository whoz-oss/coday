 ...
 * configured at all), cost estimation is skipped. When the instance is present but
 * individual rates are `null`, those components contribute 0 to the estimate — a
 * partial config still produces a meaningful (though incomplete) estimate.
 *
