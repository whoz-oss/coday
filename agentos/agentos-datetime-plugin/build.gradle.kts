...
description = "AgentOS datetime plugin - provides date/time tools"
...
publishing {
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                name.set("AgentOS Datetime Plugin")
                description.set("AgentOS datetime plugin - provides date/time tools")
