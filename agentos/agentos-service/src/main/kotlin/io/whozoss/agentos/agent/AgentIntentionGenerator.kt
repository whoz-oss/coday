...
*   Determine what is the subject of the user request: Something currently visible to them (provided via <session-context>), something mentioned in previous messages, something that needs to be retrieved or searched...
