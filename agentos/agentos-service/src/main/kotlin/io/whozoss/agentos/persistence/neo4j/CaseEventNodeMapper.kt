 ...
 */
class CaseEventNodeMapper(private val serializer: MessageContentSerializer) {
    ...
    fun withRemoved(node: CaseEventNode, removed: Boolean?): CaseEventNode =
        when (node) {
            ...
            is AgentFinishedEventNode -> AgentFinishedEventNode(node.id, node.caseId, node.namespaceId, node.timestamp, node.agentId, node.agentName, node.created, node.createdBy, node.modified, node.modifiedBy, removed)
            is AgentRunningEventNode -> AgentRunningEventNode(node.id, node.caseId, node.namespaceId, node.timestamp, node.agentId, node.agentName, node.created, node.createdBy, node.modified, node.modifiedBy, removed)
            is MessageEventNode -> MessageEventNode(node.id, node.caseId, node.namespaceId, node.timestamp, node.actorId, node.actorDisplayName, node.actorRole, node.contentJson, node.created, node.createdBy, node.modified, node.modifiedBy, removed)
            is ToolRequestEventNode -> ToolRequestEventNode(node.id, node.caseId, node.namespaceId, node.timestamp, node.toolRequestId, node.toolName, node.args, node.created, node.createdBy, node.modified, node.modifiedBy, removed)
            is ToolResponseEventNode -> ToolResponseEventNode(node.id, node.caseId, node.namespaceId, node.timestamp, node.toolRequestId, node.toolName, node.outputJson, node.success, node.created, node.createdBy, node.modified, node.modifiedBy, removed)
            is ThinkingEventNode -> ThinkingEventNode(node.id, node.caseId, node.namespaceId, node.timestamp, node.created, node.createdBy, node.modified, node.modifiedBy, removed)
            is QuestionEventNode -> QuestionEventNode(node.id, node.caseId, node.namespaceId, node.timestamp, node.agentId, node.agentName, node.question, node.options, node.created, node.createdBy, node.modified, node.modifiedBy, removed)
            is AnswerEventNode -> AnswerEventNode(node.id, node.caseId, node.namespaceId, node.timestamp, node.questionId, node.actorId, node.actorDisplayName, node.actorRole, node.answer, node.created, node.createdBy, node.modified, node.modifiedBy, removed)
            is IntentionGeneratedEventNode -> IntentionGeneratedEventNode(node.id, node.caseId, node.namespaceId, node.timestamp, node.agentId, node.intention, node.created, node.createdBy, node.modified, node.modifiedBy, removed)
    ...
    private fun fromDomain(e: CaseStatusEvent) =
        CaseStatusEventNode(
            id = e.id.toString(), caseId = e.caseId.toString(),
            namespaceId = e.namespaceId.toString(), timestamp = e.timestamp,
    ...
    private fun fromDomain(e: AgentSelectedEvent) =
        AgentSelectedEventNode(
            id = e.id.toString(), caseId = e.caseId.toString(),
            namespaceId = e.namespaceId.toString(), timestamp = e.timestamp,
            agentId = e.agentId.toString(), agentName = e.agentName,
            created = e.metadata.created, createdBy = e.metadata.createdBy,
            modified = e.metadata.modified, modifiedBy = e.metadata.modifiedBy,
            removed = e.metadata.removed.takeIf { it },
        )
    ...
    private fun fromDomain(e: MessageEvent) =
        MessageEventNode(
            id = e.id.toString(), caseId = e.caseId.toString(),
            namespaceId = e.namespaceId.toString(), timestamp = e.timestamp,
            actorId = e.actor.id, actorDisplayName = e.actor.displayName, actorRole = e.actor.role.name,
    ...
    private fun fromDomain(e: ToolRequestEvent) =
        ToolRequestEventNode(
            id = e.id.toString(), caseId = e.caseId.toString(),
            namespaceId = e.namespaceId.toString(), timestamp = e.timestamp,
            toolRequestId = e.toolRequestId, toolName = e.toolName, args = e.args,
            created = e.metadata.created, createdBy = e.metadata.createdBy,
            modified = e.metadata.modified, modifiedBy = e.metadata.modifiedBy,
            removed = e.metadata.removed.takeIf { it },
        )
    ...
    private fun fromDomain(e: ToolResponseEvent) =
        ToolResponseEventNode(
            id = e.id.toString(), caseId = e.caseId.toString(),
            namespaceId = e.namespaceId.toString(), timestamp = e.timestamp,
            toolRequestId = e.toolRequestId, toolName = e.toolName,
    ...
    private fun fromDomain(e: IntentionGeneratedEvent) =
        IntentionGeneratedEventNode(
            id = e.id.toString(), caseId = e.caseId.toString(),
            namespaceId = e.namespaceId.toString(), timestamp = e.timestamp,
            agentId = e.agentId.toString(), intention = e.intention,
            created = e.metadata.created, createdBy = e.metadata.createdBy,
            modified = e.metadata.modified, modifiedBy = e.metadata.modifiedBy,
            removed = e.metadata.removed.takeIf { it },
        )
    ...
    private fun fromDomain(e: ToolSelectedEvent) =
        ToolSelectedEventNode(
            id = e.id.toString(), caseId = e.caseId.toString(),
            namespaceId = e.namespaceId.toString(), timestamp = e.timestamp,
            agentId = e.agentId.toString(), toolName = e.toolName,
            created = e.metadata.created, createdBy = e.metadata.createdBy,
            modified = e.metadata.modified, modifiedBy = e.metadata.modifiedBy,
            removed = e.metadata.removed.takeIf { it },
        )
