package io.whozoss.agentos.chatClient
...
class ChatModelFactory {
    fun createChatModel(
        ...
        return when (provider.apiType) {
            ...
            AiApiType.Gemini -> throw IllegalArgumentException("Ah!") // createGeminiModel(provider.baseUrl, apiKey, modelName, provider.temperature)
        }
    }
