...
class IntegrationConfigServiceImpl(
    ...
    /**
     * Type-specific validators, collected by Spring. Empty by default so a context without any
     * — and every unit test building this service directly — behaves as before.
     */
    private val validators: List<IntegrationConfigValidator> = emptyList(),
