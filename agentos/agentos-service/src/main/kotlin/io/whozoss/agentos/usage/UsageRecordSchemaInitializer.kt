 ...
 * - [UsageRecordNode.namespaceId]  — namespace-scoped aggregations
 * - [UsageRecordNode.userId]       — per-user cost reporting
 * - [UsageRecordNode.timestamp]    — time-range queries in aggregation dashboards
 *
 * A UNIQUE constraint on `id` is handled globally by
 * [io.whozoss.agentos.config.Neo4jSchemaInitializer] for every node label.
 *
