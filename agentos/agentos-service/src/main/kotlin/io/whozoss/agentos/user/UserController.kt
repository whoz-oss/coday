...
class UserController(
    ...
    @Operation(operationId = "getUsersByIds")
    override fun getByIds(ids: List<UUID>) = super.getByIds(ids)

    @Operation(operationId = "listUsersByParent")
    override fun listByParent(parentId: String) = super.listByParent(parentId)

    @Operation(operationId = "createUser")
    override fun create(@Valid @RequestBody resource: UserResource) = super.create(resource)

    @Operation(operationId = "updateUser")
    override fun update(@PathVariable id: UUID, @Valid @RequestBody resource: UserResource) = super.update(id, resource)
