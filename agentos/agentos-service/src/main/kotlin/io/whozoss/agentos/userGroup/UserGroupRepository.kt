...
interface UserGroupRepository : EntityRepository<UserGroup, UUID> {
    ...
    /**
     * Unlinks the user (by external id) from every UserGroup within a single namespace.
     * Used by namespace-scoped user offboarding.
     */
    fun removeUserFromGroupsInNamespace(userExternalId: String, namespaceId: UUID)
