...
/**
 * Runs the [AbstractNamespacePersistenceTest] contract against the embedded Neo4j
...
class EmbeddedNeo4jNamespacePersistenceTest : AbstractNamespacePersistenceTest()
