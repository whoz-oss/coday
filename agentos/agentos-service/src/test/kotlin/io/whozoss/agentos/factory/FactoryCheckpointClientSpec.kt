...
class FactoryCheckpointClientSpec : StringSpec({
    ...
    fun server(statusCode: Int, responseBody: String): Pair<HttpServer, FactoryCheckpointClient> {
        ...
        server.start()
        val client = FactoryCheckpointClient(
    ...
    "sends correct URL path, headers, and body" {
        ...
        try {
            ...
            client.submitDecision(ref, "approve", "my-case", "my-actor")
            capturedPath shouldBe "/api/factory/workflows/wf-1/interactions/gate-1/reply"
            caseHeader shouldBe "my-case"
            actorHeader shouldBe "my-actor"
