...
/**
 * Runs the [AbstractAuthSettingPersistenceSpec] contract against the embedded Neo4j
 ...
 * [io.whozoss.agentos.authSetting.Neo4jAuthSettingRepository].
 */
@SpringBootTest
@ActiveProfiles("test", "embedded-neo4j")
@Import(EmbeddedNeo4jTestConfiguration::class)
class EmbeddedNeo4jAuthSettingPersistenceSpec : AbstractAuthSettingPersistenceSpec()
