...
class SkillToolGrantServiceUnitSpec : StringSpec({
    ...
    val skill1 = Skill("Code Review", "Reviews PRs", "## Body", "core/code-review", "/tmp/skills/core/code-review")
    val skill2 = Skill("Spec Writing", "Writes specs", "## Body", "product/spec", "/tmp/skills/product/spec")
