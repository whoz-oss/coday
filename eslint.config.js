...
export default [
  {
    ignores: [
      '**/dist/**',
      // Code generated by openapi-generator-cli — no linting (src/custom/ remains linted)
      'libs/agentos-api-client/src/lib/**',
    ],
  },
  // Auto-fixable unused-imports rule scoped to generated code only.
  // The global ignores above are overridden by the explicit `files` pattern here.
  {
    files: ['libs/agentos-api-client/src/lib/**/*.ts'],
