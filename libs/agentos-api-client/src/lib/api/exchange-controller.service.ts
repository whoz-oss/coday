...
// @ts-ignore
import { ExchangeDirectoryListing } from '../model/exchange-directory-listing'
// @ts-ignore
...
export class ExchangeControllerService extends BaseService {
   ...
   */
  public browseCaseFilesExchange(
    caseId: string,
    path?: string,
    page?: number,
    size?: number,
  ...
  ): Observable<ExchangeDirectoryListing>
  public browseCaseFilesExchange(
    caseId: string,
    path?: string,
    page?: number,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext; transferCache?: boolean }
  ): Observable<HttpResponse<ExchangeDirectoryListing>>
  public browseCaseFilesExchange(
    caseId: string,
    path?: string,
    page?: number,
    ...
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext; transferCache?: boolean }
  ): Observable<HttpEvent<ExchangeDirectoryListing>>
  public browseCaseFilesExchange(
    caseId: string,
    path?: string,
    page?: number,
    ...
    if (caseId === null || caseId === undefined) {
      throw new Error('Required parameter caseId was null or undefined when calling browseCaseFilesExchange.')
    }
    ...
    let localVarPath = `/api/cases/${this.configuration.encodeParam({ name: 'caseId', value: caseId, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: 'uuid' })}/files/directory`
    const { basePath, withCredentials } = this.configuration
    return this.httpClient.request<ExchangeDirectoryListing>('get', `${basePath}${localVarPath}`, {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public browseNamespaceFilesExchange(
    namespaceId: string,
    path?: string,
    page?: number,
    size?: number,
  ...
  public browseNamespaceFilesExchange(
    ...
    if (namespaceId === null || namespaceId === undefined) {
      throw new Error('Required parameter namespaceId was null or undefined when calling browseNamespaceFilesExchange.')
    }
    ...
    let localVarPath = `/api/namespaces/${this.configuration.encodeParam({ name: 'namespaceId', value: namespaceId, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: 'uuid' })}/files/directory`
    const { basePath, withCredentials } = this.configuration
    return this.httpClient.request<ExchangeDirectoryListing>('get', `${basePath}${localVarPath}`, {
      context: localVarHttpContext,
      params: localVarQueryParameters,
