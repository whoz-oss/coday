...
export class IntegrationConfigControllerService extends BaseService {
   ...
   * Scope is inferred from the query params :  | query                                              | mode             | required permission                            | |----------------------------------------------------|------------------|------------------------------------------------| | (no params)                                        | platform         | Super Admin only                               | | &#x60;?namespaceId&#x3D;&lt;uuid&gt;&#x60;                              | NS-shared        | READ on the namespace (empty list if missing)  | | &#x60;?namespaceId&#x3D;&lt;uuid&gt;&amp;userId&#x3D;me&#x60;                    | user × namespace | authenticated                                  | | &#x60;?namespaceId&#x3D;none&amp;userId&#x3D;me&#x60;                      | user-global      | authenticated                                  | | &#x60;?userId&#x3D;me&#x60; (no namespace)                        | all caller\&#39;s     | authenticated                                  |  &#x60;userId&#x60; accepts ONLY the literal sentinel &#x60;me&#x60; — a UUID returns 400 (cross-user listing is not exposed). &#x60;namespaceId&#x3D;none&#x60; is the sentinel for &#x60;namespaceId IS NULL&#x60;.  When called with no params, returns platform-level configs (Super Admin only).
   * @param namespaceId
   * @param userId
   * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
   * @param reportProgress flag to report request and response progress.
