...
// @ts-ignore
import { DeploymentScope } from '../model/deployment-scope'
// @ts-ignore
...
export class AgentConfigControllerService extends BaseService {
   ...
   * @param reportProgress flag to report request and response progress.
   */
  public getDeploymentsAgentConfig(
    id: string,
    observe?: 'body',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext; transferCache?: boolean }
  ): Observable<Array<DeploymentScope>>
  public getDeploymentsAgentConfig(
    id: string,
    observe?: 'response',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext; transferCache?: boolean }
  ): Observable<HttpResponse<Array<DeploymentScope>>>
  public getDeploymentsAgentConfig(
    id: string,
    observe?: 'events',
    reportProgress?: boolean,
    options?: { httpHeaderAccept?: 'application/json'; context?: HttpContext; transferCache?: boolean }
  ): Observable<HttpEvent<Array<DeploymentScope>>>
  public getDeploymentsAgentConfig(
    id: string,
    observe: any = 'body',
    reportProgress: boolean = false,
    ...
    if (id === null || id === undefined) {
      throw new Error('Required parameter id was null or undefined when calling getDeploymentsAgentConfig.')
    }
    ...
    let localVarPath = `/api/agent-configs/${this.configuration.encodeParam({ name: 'id', value: id, in: 'path', style: 'simple', explode: false, dataType: 'string', dataFormat: 'uuid' })}/deployments`
    const { basePath, withCredentials } = this.configuration
    return this.httpClient.request<Array<DeploymentScope>>('get', `${basePath}${localVarPath}`, {
      context: localVarHttpContext,
      responseType: <any>responseType_,
      ...(withCredentials ? { withCredentials } : {}),
      headers: localVarHeaders,
