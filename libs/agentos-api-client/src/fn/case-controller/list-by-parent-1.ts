...
export function listByParent1(http: HttpClient, rootUrl: string, params: ListByParent1$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<CaseModel>>> {
