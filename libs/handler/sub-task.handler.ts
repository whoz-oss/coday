  ...
  async handle(command: string, context: CommandContext): Promise<CommandContext> {
    ...
    if (subCommand === 'true') {
      ...
      this.interactor.warn(
        "Sub-tasking permanently enabled, this could allow nested sub-tasking and is not recommended. To disable use 'subtask false' or 'subtask [number]' to limit usage."
      )
