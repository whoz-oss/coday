...
describe('UsageLogger', () => {
  ...
  describe('when logging is disabled', () => {
    it('should not create log files', async () => {
      const logger = new UsageLogger(false, testLogDir)
  ...
  describe('when logging is enabled', () => {
    ...
    it('should buffer entries and flush periodically', async () => {
      const logger = new UsageLogger(true, testLogDir, 200) // 200ms flush interval
    ...
    it('should flush immediately when buffer gets large', async () => {
      const logger = new UsageLogger(true, testLogDir, 10000) // Long flush interval
