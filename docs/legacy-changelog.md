# Legacy Changelog (pre-Nx release)

These entries predate the Nx release system and were moved here to avoid
collisions with the automated changelog generation.
