            ...
            function: {
                ...
                parameters: {
                    ...
                    properties: {
                        ...
                        oldLineNumber: {type: ["number", "null"], description: "Line number in the old file (use null if the line is new)"},
                        newLineNumber: {type: ["number", "null"], description: "Line number in the new file (use null if the line is removed)"}
                    }
                },
                parse: JSON.parse,
