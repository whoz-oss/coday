...
export class SmallTaskFlowHandler extends CommandHandler {
    commandWord: string = 'small-task'
    description: string = 'expand the request into a simple flow of requests : analysis, implementation, review. No delegation to other assistants is encouraged and no sub-tasking.'
